...
<body>
	<div class="main">
		...
		<div class="mt10 mb10">
			...
			</select> <span class="seat"></span> <a id="addex" href="javascript:void(0)"> <span class="circular">+</span>
				新增体检
			</a> <a id="report" href="javascript:void(0)"  style="margin-left: 5px;"> <span class="circular">+</span> 体检报告
			</a>
		</div>
		...
		<div class="table3">
			<table id="datable" border="1" class="tab_content">
				<tr>
					<td>体检日期</td>
					<td colspan="2"><input name="rExamDate" id="rExamDate" type="date" value=""></input></td>
					<td>责任医生</td>
					<td colspan="2"><input type="hidden" name="DoctorID" value=""><a class="docSearch"><span
							id="DoctorName"></a></span></td>
				</tr>
				<tr class="bgf1">
					<td class="bold">内容</td>
					...
					<td colspan="5">
						<div id="symptomDiv">
							...
							<span class="optionMore">25其他<input type="text"
								name="SymptomOther" id="SymptomOther" value="" class="borderb" /></span>
						</div>
					</td>
				</tr>
				...
				<form id="bodyForm">
					...
					<tr>
						<td>身高</td>
						<td><input type="number" name="Height" id="Height" value=""
							class="borderb w40" />cm</td>
						<td>体重</td>
						<td><input type="number" name="Weight" id="Weight" value=""
							class="borderb w40" />kg</td>
						<td>/</td>
					</tr>
					<tr>
						<td>腰围</td>
						<td><input type="number" name="Waistline" id="Waistline"
							value="" class="borderb w40" />cm</td>
						<td>体质指数(BMI) <span class="bluecolor" id="help4">?</span></td>
						<td><input type="number" name="Bmi" id="Bmi" value=""
				...
				<form id="LifeStyleForm">
					<tr>
						...
						<td>锻炼频率</td>
						<td id="ExerciseFrequency"><span class="option">1每天</span> <span
			...
			<table class="tab_content" border="1" hidden="">
				<form id="OePostion">
					...
					<tr id="tr0" class="row-poison">
						...
						<td colspan="3">防护措施 <span class="option">1无</span> <span
							class="option">2有</span> <input type="number"
					...
					<tr id="tr1" class="row-poison">
						...
						<td colspan="3">防护措施 <span class="option">1是</span> <span
							class="option">2否</span> <input type="number"
							name="ProtectionMeasures" id="" value="" class="w20 borderb" />
						</td>
					</tr>
				...
				<form id="OrganForm">
					<tr>
						...
						<td colspan="3" id="Lips-option"><span class="option">1红润</span>
							...
							class="option">4皲裂</span> <span class="option">5疱疹</span> <input
							type="number" name="" id="" value="" class="w20 borderb" /></td>
					</tr>
					<tr>
						<td>齿列</td>
						<td colspan="3" id="Dentition"><span class="option">1正常</span>
							<span class="option">2缺齿</span> <span class="option">3龋齿</span> <span
							class="option">4义齿(假牙)</span> <input type="number" name="" id=""
							value="" class="borderb w20" /></td>
					</tr>
					<tr>
						<td>咽部</td>
						<td colspan="3" id="Throat"><span class="option">1</span> <span
							...
							class="option">8</span> <input type="number" name="" id=""
							value="" class="borderb w20" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="4" id="Hearing"><span class="option">1听见</span>
							<span class="option">2听不清或无法听见</span> <input type="number"
							name="" id="" value="" class="borderb w20" /></td>
					</tr>
					<tr>
						<td>运动能力<a href="file:///C:/" class="bluecolor" id="help13">?</a></td>
						<td colspan="4" id="MotorFunction"><span class="option">1可顺利完成</span>
							<span class="option">2无法独立完成气质任何一个动作</span> <input type="number"
							name="" id="" value="" class="borderb w20" /></td>
					</tr>
					<tr>
						...
						<td colspan="4" id="Fundus"><span class="option">1正常</span> <span
							class="option">2异常<input type="text" name="FundusReason"
								id="FundusReason" value="" class="borderb w40" /></span> <input
							type="number" name="" id="" value="" class="w20 borderb" /></td>
					</tr>
					<tr id="Skin">
						<td>皮肤</td>
						<td colspan="4"><span class="option">1正常</span> <span
							...
							class="option">6色素沉着</span> <span class="option">7其他<input
								type="text" name="" id="" value="" class="borderb" /></span> <input
							type="number" name="" id="" value="" class="borderb w20" /></td>
					</tr>
					<tr id="Sclera">
						<td>巩膜</td>
						<td colspan="4"><span class="option">1正常</span> <span
							...
							class="option">4其他<input type="text" name="" id=""
								value="" class="borderb" /></span> <input type="number" name="" id=""
							value="" class="borderb w20" /></td>
					</tr>
					<tr id="LymphNodes">
						<td>淋巴结</td>
					...
					<tr>
						...
						<td colspan="3" id="BarrelChest"><span class="option">1否</span>
							<span class="option">2是</span> <input type="number" name="" id=""
							value="" class="borderb w20" /></td>
					</tr>
					<tr id="BreathSounds">
						<td>呼吸音：</td>
					...
					<tr>
						...
						<td><input type="number" name="" id="" value=""
							class="w20 borderb" /> 次/分钟</td>
						<td>心律</td>
						<td id="Rhythm"><span class="option">1齐</span> <span
							class="option">2不齐</span> <span class="option">3绝对不齐</span> <input
							type="number" name="" id="" value="" class="w20 borderb" /></td>
					</tr>
					<tr>
						<td>杂音：</td>
						<td colspan="3" id="HeartMurmur"><span class="option">1无</span>
							<span class="option">2有<input type="text"
								...
								class=" borderb" />
						</span> <input type="number" name="" id="" value="" class="w20 borderb" />
						</td>
					</tr>
					<tr>
						<td rowspan="5">腹部</td>
					...
					<tr>
						...
						<td colspan="4" id="LowerExtremityEdema"><span class="option">1无</span>
							...
							<span class="option">4双侧对称</span> <input type="number" name=""
							id="" value="" class="w20 borderb" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="4" id="Dre"><span class="option">1未及异常</span> <span
							...
							class="option">4前列腺异常</span> <span class="option">5其他 <input
								type="text" name="" id="" value="" class="borderb" />
						</span> <input type="number" name="" id="" value="" class="w20 borderb" />
						</td>
					</tr>
					<tr>
				...
				<tr>
					...
					<td colspan="3" id="Vulva"><span class="option">1未见异常</span> <span
						class="option">5其他 <input type="text" name=""
				...
				<tr>
					...
					<td colspan="3" id="Vaginal"><span class="option">1未见异常</span>
						<span class="option">5其他 <input type="text" name=""
				...
				<tr>
					...
					<td colspan="4"><input type="text" name="Other" id="" value=""
						class="borderb" /></td>
				</tr>
			...
			<table class="tab_content" border="1" hidden="">
				<form id="Labor">
					...
					<tr>
						...
						</span> <input type="number" name="" id="" value="" class="borderb w20" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="4" id="FecalOccultBlood"><span class="option">1阴性</span>
							<span class="option">2阳性</span> <input type="number" name=""
							id="" value="" class="borderb w20" /></td>
					</tr>
					<tr>
				...
				<form id="ChsCons">
					<tr>
						...
						<td colspan="4" id="ModerateQuality"><span class="option">1是</span>
							<span class="option">2倾向是</span> <input type="number" name=""
							id="" value="" class="borderb w20" /></td>
					</tr>
					<tr>
						<td>气虚质</td>
					...
					<tr>
						...
						<td colspan="4"><span class="option">1是</span> <span
							class="option">2倾向是</span> <input type="number" name="" id=""
							value="" class="borderb w20" /></td>
					</tr>
					<tr>
						<td>痰湿质</td>
			...
			<table class="tab_content" border="1" hidden="">
					...
					<tr>
						...
						<td colspan="4" id="Heart"><span class="option">1未发现</span> <span
							...
							<span class="option">6心前区疼痛</span> <span class="option">
								7其他 <input type="text" name="" id="" value="" class="borderb" />
						</span></td>
					<tr>
						<td>血管疾病</td>
				...
				<tr class="add_drugTr">
					<td><input type="date" name="InDate" data-json-key="hosList"
						data-json-by="HistoryType:1" id="" value="" class="borderb" />/ <input
						type="date" name="OutDate" data-json-key="hosList"
				...
				<tr class="inBed_tr">
					<td><input type="date" name="InDate" id=""
						data-json-key="hosList" data-json-by="HistoryType:2" value=""
						class="borderb" />/ <input type="date" name="OutDate" id=""
						data-json-key="hosList" data-json-by="HistoryType:2" value=""
						class="borderb" /></td>
					<td><input type="text" name="Reason" id=""
						data-json-key="hosList" data-json-by="HistoryType:2" value=""
				...
				<form>
					...
					<tr class="drug_situation_tr">
						...
						<td><input type="text" name="MedicationTime" id="" value=""
							class="borderb w40" /> <select class="MedicationUnit">
				...
				<form>
					...
					<tr id="vaccList" class="inoculation_tr">
						<td><input type="text" name="VaccineName" id="" value=""
							class="borderb" /></td>
						<td><input type="date" name="VaccDate" id="" value=""
							class="borderb" /></td>
				...
				<tr>
					...
					<td>建议选项</td>
					<td colspan="5" id="Guidance"><span class="option">1
							纳入慢性病患者健康管理 </span> <span class="option">2 建议复查 </span> <span
						class="option">3 纳入慢性病患者健康管理 </span> <input type="number" name=""
						id="" value="" class="borderb w20" /></td>
				</tr>
				<tr>
					<td>危险因素控制</td>
					<td colspan="4" id="RiskCrtl"><span class="option">1戒烟
					</span> <span class="option">2健康饮酒 </span> <span class="option">3饮食
					</span> <span class="option">4锻炼 </span> <span class="option">5减体重
							(目标 <input type="number" name="RiskCrtlWeight" id="" value=""
							class="borderb w40" /> KG)
					</span> <span class="option">6建议接种疫苗 <input type="text"
							name="RiskCrtlVaccine" id="" value="" class="borderb" /></span> <span
						class="option">其他 <input type="text" name="RiskCrtlOther"
							id="" value="" class="borderb" /></span> <input type="number" name=""
						id="" value="" class="borderb w20" /></td>
				</tr>
				<tr>
					<td>健康摘要</td>
...
var PersonIDStr='${PersonID}'
	 ...
	 $('#addex').on('click', function () {
		     ...
		     if(radte==''||radte==null){
			    ...
			    $('#addex').attr("href", "/fdoctor/mobile/examination/toAddExamination?radte="+radte+"&userName="+"${userName}");
		     }
	});
...
//var reExamDate=$('#HealthDateList option:selected').text().trim()
...
//表回显 
 if('${RecordOneJson}' != null && '${RecordOneJson}' != ''){ 
...
var symptom=getFieldSpanValue(all_symp);
...
//将所有信息封装为统一json
	...
	if(window.confirm('是否保存？是否保存？B超,心电图,尿常规,血常规等输入提示信息是体检完善度重要标志,请确认后再保存')){
...
var userName="${userName}";
 $('#report').on('click',function(){
    ...
    $("#addex").trigger("click");
	$('#report').attr("href", "/fdoctor/mobile/report/query?remap="+remap+"&userName="+userName);
...
/* 	 $.ajax({
		 type:'GET',
		 url:'/fdoctor/mobile/examination/updateExamination',
		 data:{
			 radte:JSON.stringify(json)
		 },
	  
		 success: function(data){
			 window.navigate("/fdoctor/mobile/examination/updateExamination?radte"+JSON.stringify(json));
