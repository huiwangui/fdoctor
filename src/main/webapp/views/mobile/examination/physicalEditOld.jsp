...
<link rel="stylesheet" href="/fdoctor/statics/layui/css/layui.css"/>
 ...
 <!--  <style type="text/css">
  .delete_drug:nth-child(1){
	...
	<div class="main">
		<div class="physical_navbar">
			<ul>
				<li>
					<a href="file:///C:/">封面 <span>(必填)</span> </a>
				</li>
				<li>
					<a href="file:///C:/">基本信息 <span>(必填)</span> </a>
				</li>
				<li>
					<a href="file:///C:/">扩展信息 <span>(选填)</span> </a>
				</li>
				<li>
					<a href="file:///C:/">体检 <span></span> </a>
				</li>
				<li>
					<a href="file:///C:/">档案信息卡 <span></span> </a>
				</li>
			</ul>
		</div>
		<div class="clear"></div>
	...
	<div class="personMsg">
		...
		<div class="paging chartSearch">
          ...
          <div class="footer_btn">
          		<ul>
          			<li>
          				<a id="saveButton" href="javascript:void(0)" class="sibtn">保存</a>
          			</li>
          			<li>
          				<a href="file:///C:/" href="javascript:void(0)" class="sibtn">保存并转健康教育</a>
          			</li>
          			<li>
          				<a href="file:///C:/" href="javascript:void(0)" class="sibtn">删除</a>
          			</li>
          		</ul>
          </div>
	</div>
